...
from ui.noise_browser import NoiseCancellationBrowser  # ✅ Use actual class name from noise_browser.py
...
class MainWindow(QWidget):
    def __init__(self):
        ...
        conversion_btn = self.create_button("Conversion Image & Video", self.open_converter)
        audio_btn = self.create_button("Audio noise reduction", self.open_noise_reducer)  # ✅ Connected
        ...
        self.noise_viewer = NoiseCancellationBrowser(self.go_back_to_dashboard)
        ...
        self.stacked_layout.addWidget(self.noise_viewer)         # index 3
    ...
    def open_noise_reducer(self):  # ✅ New method
